...
<body>
      ...
      <div class="card">
        ...
        <table class="table">
          <tbody>
            ...
            <tr><td>Kecamatan</td><td>Berkas</td></tr>
    ...
    <div class="container">
      ...
      <div class="grid-3">
        <article class="card">
          ...
          <p>Kegiatan kerja bakti warga Kelurahan Berkas, Minggu pagi.</p>
        </article>
        <article class="card">
  ...
  <section id="kontak">
    <div class="container">
      ...
      <p>Alamat: Jl. Pari, Ps. Berkas, Kec. Tlk. Segara, Kota Bengkulu, Bengkulu, Indonesia</p>
      <p>Telepon: (021) 123-456</p>
      <p>Email: kelurahan@berkas.go.id</p>
    </div>
  </section>
